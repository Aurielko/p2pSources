...
//                    Logger.lg("nameOpera " + nameOpera + " "  + subscriptionInfo.getCarrierName() + " "+  telephonyManager.getSimState(subscriptionInfo.getSimSlotIndex()));
//                }
//            }
//        }
//        return result;
//    }
    ...
    public void setOperatorData(Boolean sendWithSaveOutput, Boolean sendWithSaveInput) {
      ...
      //  checkOperatorIsActive(cnt, telephonyManager );
           ...
           final List<SubscriptionInfo> activeSubscriptionInfoList = subscriptionManager.getActiveSubscriptionInfoList();
            ...
            for (SubscriptionInfo subscriptionInfo : activeSubscriptionInfoList) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                    if( telephonyManager.getSimState(simId)==5){
